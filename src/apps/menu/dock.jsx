...
<RunningText text="🚀 Добро пожаловать в документацию AtomGlide — платформы для разработчиков будущего!" />
        ...
        <Box sx={{ mb: 4 }}>
            ...
            <CodeBlock>
            AtomWilki – это раздел аналитики и продвижения сервиса, который включает анализ постов, оценку вовлеченности аудитории, разработку рекламных баннеров и изучение пользовательских предпочтений для более эффективного взаимодействия и роста платформы.
            </CodeBlock>
          </Box>
